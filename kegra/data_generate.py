            ...
            for day2 in tqdm(days):
                for day3 in days:
                    for day4 in days:
                        for day5 in days:
                            for day6 in days:
                                start_hour = timeFormat(hour)
                                end_hour = timeFormat(hour + int(sys.argv[1]))
                                ...
                                np.save('car_flow_data_{}.npy'.format(sys.argv[1]),car_flow_data)
                                np.save('labels_{}.npy'.format(sys.argv[1]),labels)
